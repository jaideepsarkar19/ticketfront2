    ...
    return (
      ...
      {this.state.data.length>0 && this.state.data.map((row,index)=>
         <TableRow key={index}>
              ...
              <TableCell align="right"><a target="_parent" href={`https://ticketing-system-for-query-resolving-0hal.onrender.com/public/${row.img}`}><img width="100px" src={`https://ticketing-system-for-query-resolving-0hal.onrender.com/public/${row.img}`}></img></a></TableCell>
